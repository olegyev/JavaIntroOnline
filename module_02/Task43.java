...
public class Task43 {
    public static void main(String[] args) {
        Task43 solution = new Task43();
        double x = Math.round(solution.generateRandomLength() * 100d) / 100d;
        double y = Math.round(solution.generateRandomLength() * 100d) / 100d;
        double z = Math.round(solution.generateRandomLength() * 100d) / 100d;
        double t = Math.round(solution.calcT(x, y, z) * 100d) / 100d;

        double s = Math.round(solution.calcQuadrangleArea(x, y, z, t) * 100d) / 100d;
    ...
    public double calcT(double x, double y, double z) {
    ...
    public double calcQuadrangleArea(double x, double y, double z, double t) {
